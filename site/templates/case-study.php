...
<main lang="en">
  <div class="case-study-container">
    <div class="case-study-hero sticky">
    ...
    <div class="case-study-text">
      ...
      <p><?php echo $page->focus() ?>: <?php echo $page->action() ?></p>
      <?php echo $page->text()->kt() ?>
      <div class="case-study-nav">
        <?php if($prev = $page->prev()): ?>
        <a class="prev" href="<?php echo $prev->url() ?>">← <?php echo $prev->title() ?></a>
        <?php endif ?>
        <?php if($next = $page->next()): ?>
        <a class="next" href="<?php echo $next->url() ?>"><?php echo $next->title() ?> →</a>
        <?php endif ?>
      </div>
    </div>
  </div>
